...
const TheaterListsByCinema = ({ cinemas, selectedCinemaIndex, setSelectedCinemaIndex, fetchCinemas, auth }) => {
    ...
    return (
        <div className="mx-4 h-fit rounded-md bg-gradient-to-br from-red-100 to-rose-50 text-gray-900 drop-shadow-md sm:mx-8">
                        ...
                        {isEditing ? (
                            <form onClick={handleSubmitName(onEditCinema)}>
                                <button
                                    ...
                                    className="flex w-fit items-center gap-1 rounded-md bg-gradient-to-r from-red-700 to-rose-600  py-1 pl-2 pr-1.5 text-sm font-medium text-white hover:from-red-600 hover:to-rose-500"
                                    onClick={() => {
                                        SetIsEditing(false)
                                    }}
                                >
            ...
            <div className="flex flex-col gap-6 p-4 sm:p-6 overflow-y-auto">
                ...
                <form className="flex flex-col gap-4" onSubmit={handleSubmit(onIncreaseTheater)}>
                    ...
                    {auth.role === 'admin' && (
                        <div className="flex w-full flex-wrap justify-between gap-4 rounded-md bg-gradient-to-br from-red-50 to-white p-4">
                            ...
                            <div className="flex grow flex-col gap-4 sm:justify-end md:flex-row">
                                ...
                                <div className="flex grow md:grow-0">
                                    ...
                                    <button
                                        ...
                                        className="flex grow items-center justify-center whitespace-nowrap rounded-r bg-gradient-to-r from-red-700 to-rose-600 px-2 py-1 font-medium text-white drop-shadow-md hover:from-red-600 hover:to-rose-500 disabled:from-slate-500 disabled:to-slate-400 md:grow-0"
                                        type="submit"
                                    >

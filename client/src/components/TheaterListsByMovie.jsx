...
const TheaterListsByMovie = ({ movies, selectedMovieIndex, setSelectedMovieIndex, auth }) => {
    ...
    return (
        <>
            <CinemaLists {...props} />
            <div className="mx-4 h-fit rounded-md bg-gradient-to-br from-red-200 to-rose-100 text-gray-900 drop-shadow-md sm:mx-8">
                            ...
                            {filteredTheaters.map((theater, index) => {
                                return (
                                    ...
                                    >
                                        {filteredTheaters[index - 1]?.cinema.name !==
                                            filteredTheaters[index].cinema.name && (
                                            <div className="rounded-t-md bg-gradient-to-br from-red-800 to-rose-700 px-2 py-1.5 text-center text-2xl font-semibold text-white sm:py-2">

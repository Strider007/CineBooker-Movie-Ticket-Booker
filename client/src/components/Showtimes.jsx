											...
											<button
												...
												className={
													isPast(new Date(showtime.showtime))
														...
														? 'flex items-center gap-1 rounded-md bg-gradient-to-br from-red-600 to-red-500 px-2 py-1 text-lg text-white drop-shadow-sm hover:from-red-500 hover:to-red-400'

...
const Search = () => {
    ...
    return (
        <div className="flex min-h-screen flex-col gap-4 bg-gradient-to-br from-red-950 to-red-600 pb-8 text-gray-900 sm:gap-8">
            <Navbar />
            <div className="mx-4 flex h-fit flex-col gap-2 rounded-lg bg-gradient-to-br from-red-200 to-red-50 p-4 drop-shadow-xl sm:mx-8 sm:p-6">
                <h2 className="text-3xl font-bold text-gray-900">Search Showtimes</h2>
                <div className="flex flex-col gap-2 rounded-md bg-gradient-to-br from-red-100 to-white p-4 transition-all duration-500 ease-in-out">
                ...
                <div className="flex items-end">
                    <ArrowDownIcon className="h-8 min-h-[32px] w-8 min-w-[32px] px-1 text-red-900" />
                    <div className="flex flex-wrap items-center gap-2 px-1">
                        <button
                            className="flex w-fit items-center justify-center gap-1 rounded bg-gradient-to-r from-red-600 to-rose-500 py-1 pl-2 pr-1.5 text-sm font-medium text-white hover:from-red-500 hover:to-rose-400 disabled:from-slate-500 disabled:to-slate-400 md:min-w-fit"
                    ...
                    {isFetchingShowtimesDone && (
                        <div className="ml-auto flex items-center gap-1 px-1 text-sm font-medium">
                            <InformationCircleIcon className="h-5 w-5 text-red-900" /> Showing {filteredShowtimes.length} filtered
                            showtimes
                        </div>
                    )}
                </div>
                ...
                <div
                    className={`mb-4 grid max-h-screen overflow-auto rounded-md bg-gradient-to-br from-red-100 to-white`}
                    ...
                    {isFetchingShowtimesDone &&
                        filteredShowtimes.map((showtime, index) => {
                            ...
                            return (
                                <Fragment key={index}>
                                    <div
                                        className={`flex items-center justify-center border-t-2 border-red-200 ${
                                            isCheckedRow && 'border-white bg-red-200 text-red-900'
                                        }`}
                                    >
                                        <input
                                            id={showtime._id}
                                    ...
                                    <div
                                        className={`border-t-2 border-red-200 px-2 py-1 ${
                                            isCheckedRow && 'border-white bg-red-200 text-red-900'
                                        }`}
                                    >
                                    ...
                                    <div
                                        className={`flex items-center gap-2 border-t-2 border-red-200 px-2 py-1 ${
                                            isCheckedRow && 'border-white bg-red-200 text-red-900'
                                        }`}
                                    >
                                        <p>
                                    ...
                                    <button
                                        className="flex items-center justify-center gap-2 bg-gradient-to-br from-red-600 to-rose-500 px-2 py-1 text-white drop-shadow-md hover:from-red-500 hover:to-rose-400 disabled:from-slate-500 disabled:to-slate-400"

...
const Tickets = () => {
    ...
    return (
        <div className="flex min-h-screen flex-col gap-4 bg-gradient-to-br from-red-950 to-red-600 pb-8 text-gray-900 sm:gap-8">
            <Navbar />
            <div className="mx-4 flex h-fit flex-col gap-4 rounded-md bg-gradient-to-br from-red-200 to-red-100 p-4 drop-shadow-xl sm:mx-8 sm:p-6">
                <h2 className="text-3xl font-bold text-gray-900">My Tickets</h2>
                {isFetchingticketsDone ? (
                    <>
                        {tickets.length === 0 ? (
                            <p className="text-center text-gray-700">You have not purchased any tickets yet</p>
                        ) : (
                                ...
                                {tickets.map((ticket, index) => {
                                    return (
                                        <div className="flex flex-col" key={index}>
                                            ...
                                            <div className="flex h-full flex-col justify-between rounded-b-lg bg-gradient-to-br from-red-100 to-white text-center text-lg drop-shadow-lg md:flex-row">

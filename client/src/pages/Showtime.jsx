...
const Showtime = () => {
    ...
    return (
        <div className="flex min-h-screen flex-col gap-4 bg-gradient-to-br from-red-950 to-red-600 pb-8 sm:gap-8">
            <Navbar />
                    ...
                    <>
                        ...
                        <div className="flex flex-col justify-between rounded-b-lg bg-gradient-to-br from-red-100 to-white text-center text-lg drop-shadow-lg md:flex-row">
                            <div className="flex flex-col items-center gap-x-4 px-4 py-2 md:flex-row">
                                {!isPast && <p className="font-semibold text-gray-900">Selected Seats : </p>}
                                <p className="text-start text-gray-900">{sortedSelectedSeat.join(', ')}</p>
                                {!!selectedSeats.length && (
                                    <p className="whitespace-nowrap text-gray-800">({selectedSeats.length} seats)</p>
                                )}
                            </div>
                            {!!selectedSeats.length && (
                                <Link
                                    ...
                                    className="flex items-center justify-center gap-2 rounded-b-lg bg-gradient-to-br from-red-600 to-rose-500 px-4 py-1 font-semibold text-white hover:from-red-500 hover:to-rose-500 md:rounded-none md:rounded-br-lg"
                                >
                                    <p>Purchase</p>
                        ...
                        <div className="mx-auto mt-4 flex flex-col items-center rounded-lg bg-gradient-to-br from-red-100 to-white p-4 text-center drop-shadow-lg">
                            <div className="w-full rounded-lg bg-white">
                                <div className="bg-gradient-to-r from-red-800 to-rose-700 bg-clip-text text-xl font-bold text-transparent uppercase tracking-wider">
                                    Screen
                                </div>
                            </div>
                            <div className="flex w-full flex-col overflow-x-auto overflow-y-hidden text-gray-900">
                        ...
                        {auth.role === 'admin' && (
                            <>
                                <h2 className="mt-4 text-2xl font-bold text-gray-900">Booked Seats</h2>
                                <div className="mt-2 flex flex-col gap-2 rounded-md bg-gradient-to-br from-red-100 to-white p-4 text-gray-900 md:flex-row">
                                ...
                                <div
                                    className={`mt-4 grid max-h-screen w-full overflow-auto rounded-md bg-gradient-to-br from-red-100 to-white text-gray-900`}
                                    style={{
